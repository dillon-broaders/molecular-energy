...
# function reads energy file and returns an array of molecular energies (labels)
...
# function calculates the interatmic distance for each molecule (i.e. features)
...
# function returns plot of energy predicitions
...
# function returns plot of loss vs epochs
...
# function returns learning curve
...
if __name__ == "__main__":
    # loop through both training data sets and generating the three plots for each
    ...
    for i, (coord_file, energy_file) in enumerate(data_sets):
        ...
        # generate learning curve (RMSE as function of training set size)
